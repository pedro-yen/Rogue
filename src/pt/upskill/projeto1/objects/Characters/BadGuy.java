...
import static pt.upskill.projeto1.objects.Items.PlateArmor.DropArmor;
...
public class BadGuy extends Enemy{
    ...
    public void looseHp(int Attack) {
        ...
        if (hp<=0){
            ...
            gui.setStatus(hero.getStatusScoreString() + "  -  "+this.getName()+" has died!" + "  + " +
                            this.getKillscore()+" points");
        }
    }
